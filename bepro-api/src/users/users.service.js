...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.register = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var exists, passwordHash, user, _, safe;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.repo.findByEmail(dto.email)];
                        case 1:
                            exists = _a.sent();
                            if (exists)
                        ...
                        case 3:
                            user = _a.sent();
                            _ = user.passwordHash, safe = __rest(user, ["passwordHash"]);
